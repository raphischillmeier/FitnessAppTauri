...
function startTraining(sectionList, sectionStart, sectionTimer, sectionPowRes, repeats) {
...
function startTimer(timer, powRes, repeats) {
    ...
    const PowerRest = document.getElementById(powRes);
...
function startFullTraining(start, list, rest) {
    ...
    const sectionRest = document.getElementById(rest);
...
function startTimer2(sectionTimer, remainingRepeats, dotts) {
    ...
    if (timerRest !== undefined) {
        ...
        if (remainingRepeats > 0) {
            ...
            const currentDott = dotts[remainingRepeats - 1];
